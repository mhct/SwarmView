...
import static io.github.agentwise.swarmview.trajectory.applications.trajectory.TestUtils.EPSILON;
import static io.github.agentwise.swarmview.trajectory.applications.trajectory.TestUtils.assertBounds;
import static io.github.agentwise.swarmview.trajectory.applications.trajectory.TestUtils.getAngularVelocity;
import static io.github.agentwise.swarmview.trajectory.applications.trajectory.TestUtils.getVelocityX;
import static io.github.agentwise.swarmview.trajectory.applications.trajectory.TestUtils.getVelocityY;
import static io.github.agentwise.swarmview.trajectory.applications.trajectory.TestUtils.getVelocityZ;
...
public class CorkscrewTrajectory4DTest {
    ...
    public void testAutoValueCache() {
        CorkscrewTrajectory4D.Point4DCache c = CorkscrewTrajectory4D.newCache(Pose.create(2, 2, 2, 2), 1);
        Assert.assertEquals(2, c.getDestinationPoint().x(), 0);
    }
