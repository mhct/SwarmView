...
public class NerveTrajectoryIntroduction implements FiniteTrajectory4d {
	...
	public NerveTrajectoryIntroduction (Pose initialPosition, Pose finalPosition, double start) throws Exception {
		...
		double[][] path = {
				...
				{    mid +  -0.06 , depth +  0.0 ,  heigh  +  0.04 , yaw +  0.07 * 3, speed +  0.12 } ,
				{    mid +  0.21 , depth +  0.02 ,  low  +  0.07 , yaw +  0.09 * 3, speed +  0.12 } ,
				{    mid +  -0.08 , depth +  0.02 ,  heigh  +  0.07 , yaw +  -0.17 * 3, speed +  -0.09 } ,
				{    mid +  0.21 , depth +  0.01 ,  low  +  0.0 , yaw +  -0.08 * 3, speed +  0.18 } ,
				{    mid +  0.02 , depth +  -0.07 ,  heigh  +  -0.11 , yaw +  0.11 * 3, speed +  0.0 } ,
				{    mid +  0.14 , depth +  -0.1 ,  low  +  -0.03 , yaw +  -0.02 * 3, speed +  0.02 } ,
				{    mid +  -0.05 , depth +  -0.12 ,  heigh  +  0.17 , yaw +  0.15 * 3, speed +  -0.16 } ,
				{    mid +  -0.09 , depth +  -0.07 ,  low  +  0.08 , yaw +  -0.15 * 3, speed +  -0.14 } ,
				{    mid +  0.22 , depth +  -0.06 ,  heigh  +  -0.06 , yaw +  0.04 * 3, speed +  0.18 } ,
				{    mid +  0.03 , depth +  0.19 ,  low  +  0.19 , yaw +  -0.04 * 3, speed +  0.19 } ,
				{    mid +  -0.26 , depth +  0.0 ,  heigh  +  0.01 , yaw +  0.03 * 3, speed +  0.08 } ,
				{    mid +  -0.09 , depth +  -0.19 ,  low  +  -0.11 , yaw +  -0.17 * 3, speed +  -0.05 } ,
				{    mid +  0.28 , depth +  0.03 ,  heigh  +  0.15 , yaw +  -0.12 * 3, speed +  0.09 } ,
				{    mid +  -0.01 , depth +  0.15 ,  low  +  -0.14 , yaw +  0.05 * 3, speed +  0.02 } ,
				{    mid +  -0.02 , depth +  -0.12 ,  heigh  +  -0.12 , yaw +  -0.06 * 3, speed +  0.01 } ,
				{    mid +  -0.26 , depth +  -0.11 ,  low  +  -0.06 , yaw +  0.08 * 3, speed +  0.06 } ,
				{    mid +  0.09 , depth +  -0.12 ,  heigh  +  -0.14 , yaw +  0.0 * 3, speed +  0.09 } ,
				{    mid +  0.1 , depth +  0.01 ,  low  +  -0.01 , yaw +  0.19 * 3, speed +  -0.04 } ,
				{    mid +  0.12 , depth +  -0.13 ,  heigh  +  0.15 , yaw +  -0.04 * 3, speed +  0.12 } ,
				{    mid +  0.03 , depth +  -0.11 ,  low  +  0.18 , yaw +  0.09 * 3, speed +  -0.11 } ,
				{    mid +  -0.28 , depth +  0.0 ,  heigh  +  0.07 , yaw +  -0.05 * 3, speed +  -0.12 } ,
				{    mid +  0.29 , depth +  -0.02 ,  low  +  0.06 , yaw +  -0.02 * 3, speed +  0.01 } ,
				{    mid +  -0.28 , depth +  0.13 ,  heigh  +  0.09 , yaw +  0.15 * 3, speed +  -0.18 } ,
				{    mid +  -0.19 , depth +  -0.12 ,  low  +  0.04 , yaw +  0.06 * 3, speed +  0.06 } ,
				{    mid +  0.04 , depth +  -0.2 ,  heigh  +  0.02 , yaw +  -0.02 * 3, speed +  0.04 } ,
				{    mid +  0.25 , depth +  0.02 ,  low  +  -0.19 , yaw +  -0.04 * 3, speed +  -0.17 } ,
				{    mid +  -0.28 , depth +  0.11 ,  heigh  +  -0.03 , yaw +  0.08 * 3, speed +  0.1 } ,
				{    mid +  0.16 , depth +  0.09 ,  low  +  0.08 , yaw +  0.02 * 3, speed +  -0.04 } ,
				{    mid +  0.17 , depth +  -0.16 ,  heigh  +  -0.05 , yaw +  -0.12 * 3, speed +  0.16 } ,
				{    mid +  -0.28 , depth +  -0.19 ,  low  +  -0.11 , yaw +  0.06 * 3, speed +  -0.03 } ,
				{    mid +  -0.03 , depth +  0.11 ,  heigh  +  0.15 , yaw +  0.1 * 3, speed +  0.18 } ,
				{    mid +  -0.21 , depth +  0.09 ,  low  +  -0.16 , yaw +  -0.19 * 3, speed +  -0.08 } ,
