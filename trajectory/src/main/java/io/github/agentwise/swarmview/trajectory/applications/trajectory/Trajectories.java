...
public final class Trajectories {
  ...
  /**
   * @param start the begin point of the trajectory.
   * @param end the end point of the trajectory.
   * @param dropHeight the height to drop in meters along the trajectory.
   * @param frequency the frequency in time of completing the motion.
   * @return A new simple pendulum trajectory with customizable angle to the xz plane.
   */
  public static Trajectory4d newShortPendulumSwingTrajectory(
      Point4D start, Point3D end, double dropHeight, double frequency) {
    return ShortSwingTrajectory4D.ShortSwingBuilder()
        .setBeginPoint(start)
        .setEndPoint(end)
  ...
  /** @return A new short swing trajectory builder. */
  public static ShortSwingTrajectory4D.ShortSwingBuilder shortSwingTrajectoryBuilder() {
    return ShortSwingTrajectory4D.ShortSwingBuilder();
  }
  ...
  public static FiniteTrajectory4d newStraightLineTrajectory(
    ...
    return StraightLineTrajectory4D.createWithCustomVelocity(sourcePoint, targetPoint, velocity);
  }

  /**
   * @param sourcePoint origin point of motion.
   * @param targetPoint destination point of motion.
   * @param duration the duration of the motion between source and target using constant velocity.
   * @return A new trajectory instance representing a straight line in space between two given
   *     points that will have a duration specified.
   */
  public static FiniteTrajectory4d newStraightLineTrajectoryWithDuration(
      Point4D sourcePoint, Point4D targetPoint, double duration) {
    return StraightLineTrajectory4D.createWithCustomTravelDuration(
        sourcePoint, targetPoint, duration);
  }
   ...
   * @return A new trajectory instance representing a straight line in space between two given
   *     points at a given enterVelocity for a specified percentage of the trajectory and an
   *     implicit smoothing towards 0 enterVelocity afterwards.
   */
  public static FiniteTrajectory4d newStraightLineWithSmoothBrakingTrajectory(
    ...
    return StraightLineTrajectory4D.createWithCustomVelocityAndCutoff(
        sourcePoint, targetPoint, velocity, brakeOnsetMark);
  }
