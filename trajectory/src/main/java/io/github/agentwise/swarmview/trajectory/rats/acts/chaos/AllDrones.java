...
import io.github.agentwise.swarmview.trajectory.rats.acts.introduction.DumboIntroduction;
import io.github.agentwise.swarmview.trajectory.rats.acts.introduction.FievelIntroduction;
import io.github.agentwise.swarmview.trajectory.rats.acts.introduction.NerveTrajectoryIntroduction;
import io.github.agentwise.swarmview.trajectory.rats.acts.introduction.TwinDrones;
...
public abstract class AllDrones {
    ...
    protected FiniteTrajectory4d getFirstLeg() {
        return TrajectoryComposite.builder()
                .addTrajectory(
                        Trajectories.newStraightLineTrajectory(getStartPoint(), getWayPoint1(),
                                baseVelocity))
    ...
    protected FiniteTrajectory4d getSecondLeg() {
        return TrajectoryComposite.builder()
                .addTrajectory(
                        Trajectories.newStraightLineTrajectory(getWayPoint1(), getWayPoint2(),
                                baseVelocity))
    ...
    protected FiniteTrajectory4d getThirdLeg() {
        return TrajectoryComposite.builder()
                .addTrajectory(
                        Trajectories.newStraightLineTrajectory(getWayPoint2(), getWayPoint3(),
                                baseVelocity))
    ...
    protected FiniteTrajectory4d getFourthLeg() {
        return TrajectoryComposite.builder()
                .addTrajectory(
                        Trajectories.newStraightLineTrajectory(getWayPoint3(), getWayPoint4(),
                                baseVelocity))
    ...
    protected FiniteTrajectory4d getLastLeg() {
        return TrajectoryComposite.builder()
                .addTrajectory(
                        Trajectories.newStraightLineTrajectory(getWayPoint4(), getEndPoint(),
                                baseVelocity))
    ...
    public static class Romeo extends AllDrones {
        ...
        protected FiniteTrajectory4d getTrajectory() {
            Point3D circleCenterPoint =
                    Point3D.plus(Point3D.project(getWayPoint1()), Point3D.create(1, 0, 0));
            Trajectory4d circleTraj =
                    Trajectories.circleTrajectoryBuilder()
                            .fixYawAt(orientation)
                            .setFrequency(frequency)
                            .setPhase(phaseToConnectStart)
                            .setRadius(circleRadius)
                            .setLocation(circleCenterPoint)
                            .build();

            FiniteTrajectory4d circle =
                    TrajectoryComposite.builder()
                            .addTrajectory(circleTraj)
                            .withDuration(circleTiming)
                            .addTrajectory(Trajectories.newHoldPositionTrajectory(getWayPoint1()))
                            .withDuration(waitAtStation)
                            .build();
            FiniteTrajectory4d intro = TwinDrones
                    .createJulietTrajectory(getStartPoint().toPose(), getWayPoint1().toPose(), 0);
            return compose(
                    Lists.newArrayList(
                            getFirstLeg(), circle, getSecondLeg(), getThirdLeg(),
    ...
    public static class Juliet extends AllDrones {
        ...
        protected FiniteTrajectory4d getTrajectory() {
            Point3D circleCenterPoint =
                    Point3D.plus(Point3D.project(getWayPoint1()), Point3D.create(0, 1, 0));
            Trajectory4d circleTraj =
                    Trajectories.circleTrajectoryBuilder()
                            .fixYawAt(orientation)
                            .setFrequency(frequency)
            ...
            FiniteTrajectory4d circle1 =
                    TrajectoryComposite.builder()
                            ...
                            .build();
            FiniteTrajectory4d intro = TwinDrones
                    .createRomeoTrajectory(getStartPoint().toPose(), getWayPoint1().toPose(), 0);

            return compose(
                    Lists.newArrayList(
                            getFirstLeg(), circle1, getSecondLeg(), getThirdLeg(),
                            getFourthLeg(), getLastLeg()));
        }
    }
    ...
    public static class Nerve extends AllDrones {
        ...
        protected FiniteTrajectory4d getTrajectory() {
            Point3D circleCenterPoint =
                    Point3D.minus(Point3D.project(getEndPoint()), Point3D.create(0, 0.5, 0));
            ...
            Trajectory4d circleTraj =
                    Trajectories.swingTrajectoryBuilder()
                            .setRadius(0.5)
                            .setFrequency(frequency)
                            .setOrigin(Point4D.from(circleCenterPoint, orientation))
                            .setXzPlaneAngle(Math.PI / 2d)
                            .build();

            FiniteTrajectory4d pendulum =
                    TrajectoryComposite.builder()
                            .addTrajectory(circleTraj)
                            .withDuration(circleTiming)
                            .addTrajectory(Trajectories.newHoldPositionTrajectory(getEndPoint()))
    ...
    public static class Fievel extends AllDrones {
        ...
        protected FiniteTrajectory4d getTrajectory() {
            ...
            FiniteTrajectory4d intro = FievelIntroduction
                    .createTrajectory(getStartPoint().toPose(), getWayPoint1().toPose(), 0);

            return compose(
                    Lists.newArrayList(
                            getFirstLeg(), getSecondLeg(), getThirdLeg(), getFourthLeg(),
                            getLastLeg()));
        }
    }
    ...
    public static class Dumbo extends AllDrones {
        ...
        protected FiniteTrajectory4d getTrajectory() {
            ...
            FiniteTrajectory4d intro = DumboIntroduction
                    .createTrajectory(getStartPoint().toPose(), getWayPoint1().toPose(), 0);
