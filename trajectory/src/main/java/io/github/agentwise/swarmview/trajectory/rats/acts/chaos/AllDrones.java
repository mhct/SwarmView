...
public abstract class AllDrones {
  ...
  protected FiniteTrajectory4d getFirstLeg() {
    return TrajectoryComposite.builder()
        .addTrajectory(
            Trajectories.newStraightLineTrajectory(getStartPoint(), getWayPoint1(), baseVelocity))
  ...
  protected FiniteTrajectory4d getSecondLeg() {
    return TrajectoryComposite.builder()
        .addTrajectory(
            Trajectories.newStraightLineTrajectory(getWayPoint1(), getWayPoint2(), baseVelocity))
  ...
  protected FiniteTrajectory4d getThirdLeg() {
    return TrajectoryComposite.builder()
        .addTrajectory(
            Trajectories.newStraightLineTrajectory(getWayPoint2(), getWayPoint3(), baseVelocity))
  ...
  protected FiniteTrajectory4d getFourthLeg() {
    return TrajectoryComposite.builder()
        .addTrajectory(
            Trajectories.newStraightLineTrajectory(getWayPoint3(), getWayPoint4(), baseVelocity))
  ...
  protected FiniteTrajectory4d getLastLeg() {
    return TrajectoryComposite.builder()
        .addTrajectory(
            Trajectories.newStraightLineTrajectory(getWayPoint4(), getEndPoint(), baseVelocity))
  ...
  public static class Romeo extends AllDrones {
    ...
    protected FiniteTrajectory4d getTrajectory() {
      ...
      return compose(
          Lists.newArrayList(
              getFirstLeg(), circle, getSecondLeg(), getThirdLeg(), getFourthLeg(), getLastLeg()));
    }
  }
  ...
  public static class Fievel extends AllDrones {
    ...
    protected FiniteTrajectory4d getTrajectory() {
      return compose(
          Lists.newArrayList(
              getFirstLeg(), getSecondLeg(), getThirdLeg(), getFourthLeg(), getLastLeg()));
    }
  }
