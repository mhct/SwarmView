...
abstract public class MultiDronesUI extends PApplet {
  ...
  public static final Color[] DEFAULT_DRONEVIEW_COLORS = {Color.CYAN, Color.YELLOW, Color.PINK, Color.GREEN, Color.BLUE};
  public static final int DEFAULT_TRAIL_LENGTH = 10;
  ...
  protected ChoreographyView choreo;
  private StageView stage;
  protected DroneView[] drones;
  protected List<CollisionView> collisions;

  public static void main(String[] args) {
    PApplet.main(MultiDronesUI.class);
  }
  ...
  abstract protected void initializeVisualization();
