...
//		fullScreen();
	...
	private void initializeTrajectories() {
		...
		ActConfiguration introConfiguration = ActConfiguration.create(100, introPositions);
		...
		ActConfiguration chaosConfiguration = ActConfiguration.create(45, chaosPositions);
		...
		ActConfiguration attackConfiguration = ActConfiguration.create(60, attackPositions);
		...
		ActConfiguration tamingConfiguration = ActConfiguration.create(120, tamingPositions);
