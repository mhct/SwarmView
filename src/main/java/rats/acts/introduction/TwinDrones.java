...
public abstract class TwinDrones {
    ...
    public static FiniteTrajectory4d createRomeoTrajectory(Pose initPos, Pose finalPos, double startTime) {
        return new Romeo(initPos, finalPos, startTime).getTrajectory();
    }

    public static FiniteTrajectory4d createJulietTrajectory(Pose initPos, Pose finalPos, double startTime) {
    ...
    public static class Romeo extends TwinDrones {
        ...
        protected FiniteTrajectory4d getTrajectory() {
            ...
            TrajectoryComposite choreo = TrajectoryComposite.builder()
                    .addTrajectory(Trajectories.newHoldPositionTrajectory(this.initPos)).withDuration(startIntroAt)
                    .addTrajectory(firstLeg)
                    .addTrajectory(Trajectories.newHoldPositionTrajectory(wp1)).withDuration(waitAtStation)
                    .addTrajectory(circleTraj).withDuration(circleTiming)
