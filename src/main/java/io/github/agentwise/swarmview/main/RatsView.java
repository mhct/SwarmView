...
//        }
        ...
        drones[0] = new DroneView(this, choreo.getFullTrajectory(DroneName.Nerve), color(0, 200, 200),
                10, DroneName.Nerve.toString());   //cyan
        drones[1] = new DroneView(this, choreo.getFullTrajectory(DroneName.Romeo), color(200, 200, 0),
                10, DroneName.Romeo.toString());  //yellow
        drones[2] = new DroneView(this, choreo.getFullTrajectory(DroneName.Juliet), color(200, 0, 200),
                10, DroneName.Juliet.toString()); //purple
        drones[3] = new DroneView(this, choreo.getFullTrajectory(DroneName.Fievel), color(0, 255, 0),
                10, DroneName.Fievel.toString());  //green
        drones[4] = new DroneView(this, choreo.getFullTrajectory(DroneName.Dumbo), color(0, 0, 250),
                10, DroneName.Dumbo.toString());   //blue
        /**
	...
	public void draw() {
		...
		//
		Optional<OfflineMinimumDistanceCheckers.Violation> violation = OfflineMinimumDistanceCheckers.checkMinimum3dDistanceConstraintAtTime(posesCurrentTime, 0.5, (timeStep)/1000.0f);
